                    ...
                    <div class="col-md-12">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>IT</td>
                                <td>Khayati Patel<span><img class="eye-img"
                                            src="./images/Admin/Rejected_Notes/eye.png"></span></td>
                                <td>09-10-2020, 10:10</td>
                                <td>Raj Sheth</td>
                                <td>Lorem Ipsum is dummy text printing industry.</td>
                                <td>
                                    <div class="admin-menu-popup">
                                        <a class="admin-menu-check" target="#arn1">
                                            <img class="dots-img" src="./images/Admin/Rejected_Notes/dots.png">
                                        </a>
                                        <div id="arn1" class="admin-menu-show">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="admin-menu-popup">
                                        <a class="admin-menu-check" target="#arn2">
                                            <img class="dots-img" src="./images/Admin/Rejected_Notes/dots.png">
                                        </a>
                                        <div id="arn2" class="admin-menu-show">
                                            <p><a href="#">Approve</a></p>
                                            <p><a href="#">Download Notes</a></p>
                                            <p><a href="#">View More Details</a></p>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="admin-menu-popup">
                                        <a class="admin-menu-check" target="#arn3">
                                            <img class="dots-img" src="./images/Admin/Rejected_Notes/dots.png">
                                        </a>
                                        <div id="arn3" class="admin-menu-show">
                                            <p><a href="#">Approve</a></p>
                                            <p><a href="#">Download Notes</a></p>
                                            <p><a href="#">View More Details</a></p>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="admin-menu-popup">
                                        <a class="admin-menu-check" target="#arn4">
                                            <img class="dots-img" src="./images/Admin/Rejected_Notes/dots.png">
                                        </a>
                                        <div id="arn4" class="admin-menu-show">
                                            <p><a href="#">Approve</a></p>
                                            <p><a href="#">Download Notes</a></p>
                                            <p><a href="#">View More Details</a></p>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="admin-menu-popup">
                                        <a class="admin-menu-check" target="#arn5">
                                            <img class="dots-img" src="./images/Admin/Rejected_Notes/dots.png">
                                        </a>
                                        <div id="arn5" class="admin-menu-show">
                                            <p><a href="#">Approve</a></p>
                                            <p><a href="#">Download Notes</a></p>
                                            <p><a href="#">View More Details</a></p>
                                        </div>
                                    ...
                                    <li class="page-item">
                                        <a class="page-link" href="#">
                                            <img class="left-arrow-img"
                                                src="./images/Admin/Rejected_Notes/left-arrow.png">
                                        </a>
                                    </li>
                                    ...
                                    <li class="page-item">
                                        <a class="page-link" href="#">
                                            <img class="right-arrow-img"
                                                src="./images/Admin/Rejected_Notes/right-arrow.png">
                                        </a>
                                    </li>
                                </ul>
                        </div>
