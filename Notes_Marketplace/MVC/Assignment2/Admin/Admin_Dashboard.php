                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="admin-menu-popup">
                                            <a class="admin-menu-check" target="#ad1">
                                                <img class="dots-img" src="./images/Admin/Dashboard/dots.png">
                                            </a>
                                            <div id="ad1" class="admin-menu-show">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="admin-menu-popup">
                                            <a class="admin-menu-check" target="#ad2">
                                                <img class="dots-img" src="./images/Admin/Dashboard/dots.png">
                                            </a>
                                            <div id="ad2" class="admin-menu-show">
                                                <p><a href="#">Download Note</a></p>
                                                <p><a href="#">View More Details</a></p>
                                                <p><a href="#">Unpublish</a></p>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="admin-menu-popup">
                                            <a class="admin-menu-check" target="#ad3">
                                                <img class="dots-img" src="./images/Admin/Dashboard/dots.png">
                                            </a>
                                            <div id="ad3" class="admin-menu-show">
                                                <p><a href="#">Download Note</a></p>
                                                <p><a href="#">View More Details</a></p>
                                                <p><a href="#">Unpublish</a></p>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="admin-menu-popup">
                                            <a class="admin-menu-check" target="#ad4">
                                                <img class="dots-img" src="./images/Admin/Dashboard/dots.png">
                                            </a>
                                            <div id="ad4" class="admin-menu-show">
                                                <p><a href="#">Download Note</a></p>
                                                <p><a href="#">View More Details</a></p>
                                                <p><a href="#">Unpublish</a></p>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="admin-menu-popup">
                                            <a class="admin-menu-check" target="#ad5">
                                                <img class="dots-img" src="./images/Admin/Dashboard/dots.png">
                                            </a>
                                            <div id="ad5" class="admin-menu-show">
                                                <p><a href="#">Download Note</a></p>
                                                <p><a href="#">View More Details</a></p>
                                                <p><a href="#">Unpublish</a></p>
                                            </div>
                                        ...
                                        <li class="page-item">
                                            <a class="page-link" href="#">
                                                <img class="left-arrow-img"
                                                    src="./images/Admin/Dashboard/left-arrow.png">
                                            </a>
                                        </li>
                                        ...
                                        <li class="page-item">
                                            <a class="page-link" href="#">
                                                <img class="right-arrow-img"
                                                    src="./images/Admin/Dashboard/right-arrow.png">
                                            </a>
                                        </li>
                                    </ul>
                            </div>
