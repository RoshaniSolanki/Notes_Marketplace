...
<form action="" method="post">
    ...
    <div class="modal" id="confirm-box" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="col-md-7 col-sm-12 col-xs-12">
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-7">
                        ...
                        <button class="note-details-page-download-btn" data-toggle="modal"
                            data-target="#confirm-box">DOWNLOAD/&#36;<?php echo $price; ?></button>
                        <?php 
                                    }
                            }else {?>
